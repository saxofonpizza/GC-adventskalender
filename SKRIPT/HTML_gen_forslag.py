...
#   Utlegg - TABELL   #
#######################
    fil_utlegg = open(filnavn_utleggs_tabell, "w")
    fil_utlegg.write("""
<table class="Utlegg">
    <tr>
...
#HER KAN TEKST OVER TABELLEN SKRIVES I HTML
    TEKST = f"""
    <center>
        <p class="tittel1" id="Tittel">Forslag X-Mjøs 2023 - ADVENTSKALENDER</p>
...
"""
    ...
    <head>
        ...
        <title>Forslag Poengtavle 2023</title>
        <meta charset="UTF-8">
...
########################
    fil_tabell_tittel = open(filnavn_tabell_tittel, "w")
    ...
    fil_tabell_data = open(filnavn_tabell_data, "w")   # Tømmer filen
    fil_tabell_data.close()                           # Tømmer filen

    fil_cachetype = open(filnavn_tabell_cachetype, "w")
    fil_cachetype.write("""
    <tr> 
        <th style="background:#511010;"></th>
        <th style="background:#511010;"></th>
        <th style="background:#511010;"></th>""")
    fil_cachetype.close()
...
# SCOREBOARD - TABELL #
#######################
    fil_tabell_tittel = open(filnavn_tabell_tittel, "a")
    fil_tabell_data = open(filnavn_tabell_data, "a")
    fil_cachetype = open(filnavn_tabell_cachetype, "a")
    ...
    fil_tabell_tittel   = open(filnavn_tabell_tittel, "r")
    fil_tabell_data     = open(filnavn_tabell_data, "r")
    fil_cachetype       = open(filnavn_tabell_cachetype, "r")
    fil_utlegg          = open(filnavn_utleggs_tabell)
    ...
    # html = html_header + fil_utlegg + '<table class="Scoreboard">' + tabell_cachetype + tabell_tittel + tabell_data + html_footer
    ...
    fil_komplett = open(filnavn_HTML_komplett, "w")
