...
(NULL, 'KonkurranseSlutt'                   ,'2023-12-24'                      ,'Tid'                      ,'dato'             ,'Dato på når konkurransen er ferdig (yyyy-mm-dd). Funn etter dette tidspunktet vil ikke telle med i konkurransen', current_timestamp()),
