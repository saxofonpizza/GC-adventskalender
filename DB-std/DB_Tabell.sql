...
(NULL, 'IMAP_srv'                           ,'<IMAP-mailserver>'               ,'Mailoppsett'              ,'URL'              ,'IMAP-server til mailadressen som skal motta mails angående nytt utlegg eller ny logg ', current_timestamp()),
...
(NULL, 'Intervall1'                         ,'01'                              ,'Intervall'                ,'tall'             ,'Her settes lengden på intervall 1. Til og med hvor mange dager etter utleggsdato skal intervallet gjelde?', current_timestamp()),
(NULL, 'Intervall2'                         ,'02'                              ,'Intervall'                ,'tall'             ,'Her settes lengden på intervall 2. Til og med hvor mange dager etter utleggsdato skal intervallet gjelde?', current_timestamp()),
(NULL, 'Intervall3'                         ,'03'                              ,'Intervall'                ,'tall'             ,'Her settes lengden på intervall 3. Til og med hvor mange dager etter utleggsdato skal intervallet gjelde?', current_timestamp()),
(NULL, 'Intervall4'                         ,'04'                              ,'Intervall'                ,'tall'             ,'Her settes lengden på intervall 4. Til og med hvor mange dager etter utleggsdato skal intervallet gjelde?', current_timestamp()),
